...
a persistence unit "ExamenAndradeCarlosClientePersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "ExamenAndradeCarlosCliente\pom.xml":
...
artifact ("ExamenAndradeCarlosCliente.war") is already built. You can build
